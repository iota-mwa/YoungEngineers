...
class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.jiaDeText = this.add.text(100, 100, 'Use W and S Keys to move', { fontSize: '32px', fill: '#fff' });
    
        this.opponentScoreText = this.add.text(700, 50, 'Opponent: 0', { fontSize: '32px', fill: '#fff' });
        this.opponentText = this.add.text(700, 100, 'Use arrow keys to move', { fontSize: '32px', fill: '#fff' });
